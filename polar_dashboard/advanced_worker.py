...
# The physical device cache to bypass DBus lookup errors
ble_device_cache = {}
...
async def main():
    ...
    while True:
        ...
        try:
            ...
            # Pull the actual device object from the cache instead of asking DBus to find it
            ...
            if device:
                async with PolarDevice(device) as polar:
                    ...
                    # Relies on the Watchdog Timer software timeout
